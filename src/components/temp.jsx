...
export const Temp = () => {
  ...
  return (
    <div
      className={`${styles.events} bg-[#222] text-white h-full flex flex-col items-center overflow-auto leading-6 p-2`}
    >
      <h1
        className={`text-center mt-3 font-montserrat text-transparent`}
        style={{
      ...
      <div className={`${styles.about} text-center mt-3 font-raleway`}>
        <p>
          ...
          Year Including Speaker Ses sions With Renowned Technocrats,
